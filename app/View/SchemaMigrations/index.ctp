<div class="schemaMigrations index">
	...
	<tr>
		...
		<td class="actions">
			...
			<?php echo $this->Form->postLink(__('Delete'), array('action' => 'delete', $schemaMigration['SchemaMigration']['id']), array(), __('Are you sure you want to delete # %s?', $schemaMigration['SchemaMigration']['id'])); ?>
		</td>
	</tr>
<?php endforeach; ?>
	</tbody>
