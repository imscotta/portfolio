...
<div class="actions">
	...
	<ul>
		...
		<li><?php echo $this->Form->postLink(__('Delete'), array('action' => 'delete', $this->Form->value('SchemaMigration.id')), array(), __('Are you sure you want to delete # %s?', $this->Form->value('SchemaMigration.id'))); ?></li>
