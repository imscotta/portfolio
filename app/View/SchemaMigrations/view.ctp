...
<div class="actions">
	...
	<ul>
		...
		<li><?php echo $this->Form->postLink(__('Delete Schema Migration'), array('action' => 'delete', $schemaMigration['SchemaMigration']['id']), array(), __('Are you sure you want to delete # %s?', $schemaMigration['SchemaMigration']['id'])); ?> </li>
