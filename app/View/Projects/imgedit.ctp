...
<?php echo $this->Form->create('Project'); ?>
	...
	<?php
		...
		echo $this->Form->input('topic5desc');
			...
			echo $this->Form->input('topic1photo');
		echo $this->Form->input('topic2photo');
		echo $this->Form->input('topic3photo');
		echo $this->Form->input('topic4photo');
		echo $this->Form->input('topic5photo');
